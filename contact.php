...
<script src="./js/hash/emailAutoComplete.min_7b1dcf0.min.js"></script>
<script src="./js/hash/zan.min_5e8802d.min.js"></script>
<!--定时器-->
<script src="./js/hash/timer.min_20425d1.min.js"></script>
<script src="./js/hash/contact.min_6185a78.min.js"></script>
</body>
</html>