...
<!--                    推荐内容-->
    ...
    <script src="js/hash/common.min_9e4ad2c.js"></script>
    <!--推荐-->
    <script src="./js/hash/recommend.min_10a524e.js"></script>
    <!--搞笑和激励-->
    <script src="./js/hash/fightAndInteresting.min_a869fd2.js"></script>

    <script  src="js/hash/life.min_fdcd6a0.js"></script>
